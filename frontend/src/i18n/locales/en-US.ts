export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      questionsEmpty: 'No generated questions yet',
      questionSourceLabel: 'Source chunk',
      questionSourceMissing: 'The source chunk was deleted or is unavailable',
      questionChunkBadge: 'Chunk {index}',
      questionOutdated: 'Chunk content updated',
