export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      questionsEmpty: 'Сгенерированных вопросов пока нет',
      questionSourceLabel: 'Исходный фрагмент',
      questionSourceMissing: 'Исходный фрагмент удалён или недоступен',
      questionChunkBadge: 'Фрагмент {index}',
      questionOutdated: 'Содержимое фрагмента обновлено',
