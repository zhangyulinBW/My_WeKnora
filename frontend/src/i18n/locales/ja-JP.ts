export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      questionsTab: '質問',
      questionsEmpty: '生成された質問はまだありません',
      questionSourceLabel: '出典チャンク',
      questionSourceMissing: '出典チャンクは削除されたか利用できません',
      questionChunkBadge: 'チャンク {index}',
      questionOutdated: 'チャンク内容が更新済み',
      filterEntity: 'エンティティ',
      filterConcept: '概念',
      filterSynthesis: '総合',
      filterComparison: '比較',
