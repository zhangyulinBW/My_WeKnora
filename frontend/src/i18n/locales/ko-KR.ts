export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      filterKnowledge: '지식',
      questionsTab: '질문',
      questionsEmpty: '생성된 질문이 없습니다',
      questionSourceLabel: '출처 청크',
      questionSourceMissing: '출처 청크가 삭제되었거나 사용할 수 없습니다',
      questionChunkBadge: '청크 {index}',
      questionOutdated: '청크 내용 업데이트됨',
      filterEntity: '엔티티',
      filterConcept: '개념',
      filterSynthesis: '종합',
      filterComparison: '비교',
