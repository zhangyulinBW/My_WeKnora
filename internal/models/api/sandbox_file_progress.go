...
// IsSandboxMutationTool reports whether a tool name writes sandbox files.
func IsSandboxMutationTool(name string) bool {
	return name == writeSandboxFileName || name == editSandboxFileName
}

// SandboxFileProgress tracks a streamed write/edit tool call and emits
// throttled progress payloads.
...
// NewSandboxFileProgress creates a tracker for one tool call.
